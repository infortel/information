 ...
 * @author leon
 */
public class Cmd_adm_Log_User_Passwords {
//******************************************************************************
    public static final String TITLE="Report Password Authorization";
//******************************************************************************
//******************************************************************************
    PrintWriter out;
    GeneralParams p;
//******************************************************************************
    public Cmd_adm_Log_User_Passwords(GeneralParams p, PrintWriter out) {
        this.out=out;
        this.p=p;
...
//******************************************************************************
    public void list() {
        ...
        ListString list=Log_Password.getLogContext();
